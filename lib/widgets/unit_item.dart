...
class UnitItem extends StatefulWidget {
  ...
  String? distance;
  String? location;
  // status current or finished or left
  String? status;
  String? title;
  String? time;
  String? price;
                      ...
                      Center(
                        child:  Padding(
                          ...
                          child: Text(
                            widget.status!,
                            textScaleFactor: .85,
                            style:  const TextStyle(color: Colors.white,fontSize: FontSize.s14),
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                           ...
                           Icon((widget.screenType==1&&!HomeCubit.get(context).followedList[widget.auctionId]!)||
                               (widget.screenType==2&&!OnGoingAuctionCubit.get(context).currentFollowedList[widget.auctionId]!)||
                               (widget.screenType==3&&!InComingAuctionCubit.get(context).nextFollowedList[widget.auctionId]!)?
                               Icons.add:Icons.check,color: ColorManager.primary,size: 20,
                              ),
                             Text(
                  ...
                  child: Container(
                    ...
                    child: Center(
                      child: RichText(
                        ...
                        textAlign: TextAlign.center,
                        text: TextSpan(
                          text: widget.isFinished ==false?AppLocalization.of(context).translate('Current Bid')!
                          :AppLocalization.of(context).translate('Selling price')!,
                          ...
                          children:  [
                            ...
                            TextSpan(
                              text:' ${widget.price!}  ${AppLocalization.of(context).translate('Sar')}',
                              style: TextStyle(
                                fontFamily:CasheHelper.getData(key: 'isArabic')==true?'GE':'Gill',
                                fontWeight: FontWeight.w400,
                                fontSize:FontSize.s14,
                                color: Colors.white,
