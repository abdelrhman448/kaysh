...
class AuctionDetails {
  ...
  int? endTime;
   ...
   AuctionDetails.fromMap(Map<String, dynamic> json) {
     ...
     realestateProperties= List<RealestateProperty>.from(json["realestate_properties"].map((x) => RealestateProperty.fromMap(x)));
     ...
     realestateImages= List<RealestateImage>.from(json["realestate_images"].map((x) => RealestateImage.fromMap(x)));
     status= json["status"];
