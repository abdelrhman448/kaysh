...
class Data {
  ...
  int? userStatus;
   ...
   Data.fromMap(Map<String, dynamic> json) {
    currentAuctions= List<AuctionDetails>.from(json["CurrentAuctions"].map((x) => AuctionDetails.fromMap(x)));
    nextAuctions= List<AuctionDetails>.from(json["nextAuctions"].map((x) => AuctionDetails.fromMap(x)));
    doneAuctions= List<AuctionDetails>.from(json["doneAuctions"].map((x) =>AuctionDetails.fromMap(x)));
