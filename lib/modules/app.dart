...
class App extends StatelessWidget {
   ...
   MaterialColor color= const MaterialColor(
      0xFFC8C91E,
      {
         50: Color(0xFFC8C91E),
  ...
  Widget build(BuildContext context) {
    ...
    return   MultiBlocProvider(
      providers: [
        ...
        BlocProvider(create:(context)=> AccountVerificationCubit()..getCity()),
        ...
        builder: (context,state){
          ...
          return OverlaySupport.global(
            child: MaterialApp(
              ...
              locale:CasheHelper.getData(key: 'isArabic')==false? const  Locale('en', 'US'):const Locale('ar', 'EG'),
