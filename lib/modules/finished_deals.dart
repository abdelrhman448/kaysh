    ...
    return BlocProvider(
      ...
      child: BlocConsumer<DoneAuctionCubit,DoneStates>(
        ...
        builder: (context,state){
          ...
          return  Scaffold(
            appBar:  AppBar(
              title: Text(AppLocalization.of(context).translate('Finished deals')!,style: appBarTitle),
              centerTitle: true,
              elevation: 0.0,
              leading:IconButton(
            ...
            body: Conditional.single(
              ...
              widgetBuilder: (context)=>cubit.doneAuctionModel!=null?SmartRefresher(
                enablePullDown: true,
                enablePullUp: true,
                ...
                onLoading: ()async{
                  cubit.getDoneAuction().then((value) {
                    print(cubit.currentPage);
                    if(cubit.currentPage<cubit.doneAuctionModel!.data!.nextAuctions!.total!) {
                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            Text(AppLocalization.of(context).translate('Finished deals')!,style: onTabTextStyle),
                          ],
                        ),
                          ...
                          itemBuilder: (context,index)=>InkWell(
                            onTap: (){
                              if(CasheHelper.getData(key: isVerified)) {
                                navigateTo(
                                    context: context, nextScreen: DealsDetailsScreen(auctionId: cubit.doneAuctionModel!.data!.nextAuctions!.data[index].id!));
                              }
                              else {
                                Alert(
                                    context: context,
                                    ...
                                    style:AlertStyle(
                                      ...
                                      titleStyle:Styles.getMidMainTextStyle(color: Colors.black,fontSize: FontSize.s16),
                            ...
                            child: UnitItem(
                              ...
                              price: cubit.allData[index].maximum.toString(),
                ...
                Center(
                  ...
                  : Center(child: Text(AppLocalization.of(context).translate('No auction')!)),
