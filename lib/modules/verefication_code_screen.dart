                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Directionality(
                        ...
                        child: PinCodeTextField(
                          ...
                          onCompleted: (value) {
                            ...
                            //     phoneNumber: CasheHelper.getData(key: 'phoneNumber'),
                            //   smsCode: value,
                            //   verificationId: CasheHelper.getData(key: 'verificationToken'),
                            // );
                            cubit.signIn(phoneNumber: CasheHelper.getData(key: 'phoneNumber'));
                            ...
                            builder: (context, state) {
                              if (state is! LoginLoadingState) {
                                return TextButton(
                                  ...
                                  onPressed: () {
                                    SignInCubit.get(context).sendCodeVerification(mobileNumber:  CasheHelper.getData(key: 'phoneNumber'));
                                  },
                                );
                              }
                              else{
                      ...
                      if (state is VerificationCodeInitialState||state is VerificationCodeErrorState)
                        Row(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            DefaultText(
