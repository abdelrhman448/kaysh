    ...
    return BlocProvider(
      ...
      child: BlocConsumer<InComingAuctionCubit,InComingAuctionStates>(
        ...
        builder: (context,state){
          ...
          return Scaffold(
            appBar:  AppBar(
              title: Text(AppLocalization.of(context).translate('Upcoming Deals')!,style: appBarTitle),
              centerTitle: true,
              elevation: 0.0,
              leading:IconButton(
            ...
            body: Conditional.single(
              conditionBuilder:(context)=>state is !InComingAuctionInitialState,
              context: context,
              fallbackBuilder:(context)=>Center(child: MyCircularPrograssIndicator()),
              widgetBuilder: (context)=>cubit.inComingAuctionModel!=null? SmartRefresher(
                enablePullUp: true,
                enablePullDown: true,
                reverse: false,
                primary: false,
                ...
                onLoading: ()async{
                  ...
                  cubit.getIncomingAuction().then((value) {
                    print(cubit.currentPage);
                    if(cubit.currentPage<cubit.inComingAuctionModel!.data!.nextAuctions!.total!) {
                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            Text(AppLocalization.of(context).translate('Upcoming Deals')!,style: onTabTextStyle),
                          ],
                        ),
                            ...
                            onTap: (){
                              if(CasheHelper.getData(key: isVerified)) {
                                navigateTo(
                                    ...
                                    context: context, nextScreen:DealsDetailsScreen(auctionId: cubit.inComingAuctionModel!.data!.nextAuctions!.data[index].id!));
                              }
                              else {
                                Alert(
                                    context: context,
                            ...
                            child: UnitItem(
                              ...
                              onFollowTab: (){
                                if(!CasheHelper.getData(key: isVerified)){
                                  ...
                                  cubit.nextFollowedList[cubit.allData[index].id!]=!cubit.nextFollowedList[cubit.allData[index].id!]!;
                                  cubit.addFollow(cubit.allData[index].id!);
                                }
                              },
                              auctionId: cubit.allData[index].id,
                              image: cubit.allData.elementAt(index).realestateImage,
                              width: width*.75,
                              ...
                              price: '2532422',
                              status: nextAuctionLeftTime(context: context,adTime: 1639611600),
