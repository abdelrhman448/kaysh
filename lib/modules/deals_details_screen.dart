...
class DealsDetailsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create:  (context)=>DealsDetailsCubit()..getAuctionDetails(auctionId: auctionId),
      child: BlocConsumer<DealsDetailsCubit,DealsDetailsStates>(
        ...
        builder: (context,state){
          ...
          return Scaffold(
            ...
            appBar: AppBar(
              title: Text(AppLocalization.of(context).translate('Auction details')!,style: appBarTitle,),
              centerTitle: true,
              elevation: 0.0,
              leading: IconButton(
                  ...
                  children: [
                        ...
                        children: [
                          Container(
                            ...
                            child: CarouselSlider(
                              ...
                              items:cubit.dealsDetailsModel!.data!.auctionDetails!.realestateImages.map((e) {
                                return Builder(
                          ...
                          AnimatedSmoothIndicator(
                            ...
                            count: cubit.dealsDetailsModel!.data!.auctionDetails!.realestateImages.length,
                          ...
                          Row(
                            ...
                            children: [
                              Text(
                               cubit.dealsDetailsModel!.data!.auctionDetails!.realestateTitle!,
                                style: Styles.getMidMainTextStyle(color: Colors.black,fontSize: FontSize.s16),
                              ),
                            ],
                          ),
                          const SizedBox(height: 16,),
                          if(cubit.dealsDetailsModel!.data!.auctionDetails!.realestateProperties.isNotEmpty)
                          Column(
                            children: [
                              Row(
                                crossAxisAlignment: CrossAxisAlignment.start,
                              ...
                              Container(
                                ...
                                child: Scrollbar(
                                  ...
                                  child: ListView.separated(
                                    ...
                                    itemBuilder: (context,index)=>BuildDescriptionItem(
                                      value: cubit.dealsDetailsModel!.data!.auctionDetails!.realestateProperties[index].value,
                                      name:  cubit.dealsDetailsModel!.data!.auctionDetails!.realestateProperties[index].name,
                                    ),
                                    separatorBuilder: (context,index)=> const SizedBox(width: 32,),
                                    itemCount: cubit.dealsDetailsModel!.data!.auctionDetails!.realestateProperties.length,
                          ...
                          ReadMoreText(
                            cubit.dealsDetailsModel!.data!.auctionDetails!.realestateDescription!,
                            style: bidsTextStyle,
                            trimLength: 100,
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  ...
                                  child: TextButton(
                                    ...
                                    onPressed: (){
                                      navigateTo(context: context, nextScreen: MapScreen(
                                        latitude: cubit.dealsDetailsModel!.data!.auctionDetails!.latitude,
                                        longtude: cubit.dealsDetailsModel!.data!.auctionDetails!.longitude,
                                        address: cubit.dealsDetailsModel!.data!.auctionDetails!.address,
                                      ));
                                    },
                                  ),
                                ),
                          ...
                          Padding(
                            padding: const EdgeInsetsDirectional.only(bottom: 16,end: 5),
                            child: Text(
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(
                           AppLocalization.of(context).translate('property age')!,
                            style: Styles.getMidMainTextStyle(color: Colors.black,fontSize: FontSize.s16),
                          ),
                          ...
                          Padding(
                            ...
                            child: Text(
                             ' ${cubit.dealsDetailsModel!.data!.auctionDetails!.age!}',
                              style: Styles.getBoldSecondryTextStyle(color: Colors.black,fontSize: FontSize.s16),
                            ),
                          ),
                          const SizedBox(width: 8,),
                          Text(
                    ...
                    if(cubit.dealsDetailsModel!.data!.auctionDetails!.status==1)
                      Container(
                        height :6,
                        width: double.infinity,
                        color: Colors.grey.shade200,
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child:  CountdownTimer(
                                endTime:currentAuctionCounter(endTime: cubit.dealsDetailsModel!.data!.auctionDetails!.endTime!),
                                ...
                                widgetBuilder: (context, CurrentRemainingTime? time) {
                                  if(time==null){
                                    ...
                                    return  Text('00,00',style: timeTextStyle.copyWith(color: Colors.grey.shade600),);
                                  }
                                  return Text(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                InkWell(
                                  onTap: (){
                                    print('===>${auctionId}');
                                    navigateTo(context: context, nextScreen: BidsScreen(id: auctionId,));
                                  },
                            ...
                            Conditional.single(
                                ...
                                widgetBuilder: (context)=>Column(
                                  children: [
                                    DealsBidsItem(
                                      time: '${DateTime.parse(cubit.all.first.time!).hour} : ${DateTime.parse(cubit.all.first.time!).minute} : ${DateTime.parse(cubit.all.first.time!).second}',
                                      date:  '${DateTime.parse(cubit.all.first.time!).day} / ${DateTime.parse(cubit.all.first.time!).month} / ${DateTime.parse(cubit.all.first.time!).year}',
                                      lastPrice:  cubit.all.first.bidValue,
                                    ),
                                    ...
                                    if(cubit.all.length>=2)
                                      DealsBidsItem(
                                        time: '${DateTime.parse(cubit.all[1].time!).hour} : ${DateTime.parse(cubit.all[1].time!).minute} : ${DateTime.parse(cubit.all[1].time!).second}',
                                        date: '${DateTime.parse(cubit.all[1].time!).day} / ${DateTime.parse(cubit.all[1].time!).month} / ${DateTime.parse(cubit.all[1].time!).year}',
                                    ...
                                    if(cubit.all.length>=3)
                                      DealsBidsItem(
                                        time: '${DateTime.parse(cubit.all[2].time!).hour} : ${DateTime.parse(cubit.all[2].time!).minute} : ${DateTime.parse(cubit.all[2].time!).second}',
                                        date: '${DateTime.parse(cubit.all[2].time!).day} / ${DateTime.parse(cubit.all[2].time!).month} / ${DateTime.parse(cubit.all[2].time!).year}',
                    ...
                    const SizedBox(height: 16,),
                    if(cubit.dealsDetailsModel!.data!.auctionDetails!.status==3)
                              ...
                              child: Row(
                                children: [
                                  Padding(
                                    padding: const EdgeInsets.only(top: 4),
                                    child: Text(
                                      cubit.dealsDetailsModel!.data!.auctionDetails!.maximumPrice!.toString(),
                                      style: bodyTextStyle.copyWith(fontWeight: FontWeight.w400,fontFamily: 'Gill',color:ColorManager.primary ),
                                    ),
                                  ),
                                  const SizedBox(width: 8,),
                                  Text(
                                    ...
                                    textAlign: TextAlign.center,
                                    style: bodyTextStyle.copyWith(color:Colors.black,fontFamily: 'Gill'),
                                  ),
                    ...
                    if(cubit.dealsDetailsModel!.data!.auctionDetails!.desireValue!=0)
                    Column(
                      children: [
                        const SizedBox(height: 16,),
                        Container(
                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  PriceTableItem(
                                    title: 'Highest price',
                                    price: DealsDetailsCubit.get(context).highestPrice.toString() ,
                                  ),
                                  Container(
                                    height: 65,
                                    width: 2,
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          InkWell(
                                            ...
                                            onTap: (){
                                              if(cubit.bidCounter!-cubit.tenderValue!>=cubit.tenderValue!) {
                                          ...
                                          Padding(
                                            ...
                                            child: InkWell(
                                              ...
                                              onTap: (){
                                                ...
                                                if(int.parse(cubit.bidValueController.text)<cubit.tenderValue!){
                                                  Alert(
                                                      style:AlertStyle(
                                                        ...
                                                        DialogButton(
                                                          child: Container(
                                                            ...
                                                            child: Text(
                                                              ...
                                                              style:  Styles.getBoldMainTextStyle(color: Colors.white,fontSize: FontSize.s22),
                                                            ),
                                                      ...
                                                      context: context,
                                                      title: '${AppLocalization.of(context).translate('Please add number more than')} ${cubit.dealsDetailsModel!.data!.auctionDetails!.tendersValue}'
                                                  ...
                                                  cubit.increaseHighestPrice().then((value) {
                                                    DealsDetailsCubit.get(context).sendBid(value: cubit.highestPrice!.toString(), userId: ProfileCubit.get(context).profileModel!.data!.profile!.id!,auctionId: auctionId);
                                                    cubit.sendBidToApi(cubit.highestPrice!, cubit.dealsDetailsModel!.data!.auctionDetails!.id!);
                                                  });
