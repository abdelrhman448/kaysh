            ...
            child: Column(
              ...
              children: [
                Row(
                  ...
                  children:  [
                    const Image(image: AssetImage('icons/lang.png'),width: 25,),
                   ...
                   if(CasheHelper.getData(key: 'isArabic')==false)
                    ...
                    if(CasheHelper.getData(key: 'isArabic')==true||CasheHelper.getData(key: 'isArabic')==null)
                      Padding(
                        padding: const EdgeInsets.only(bottom: 4,top: 4),
                        child: Text(
                          'عربي',
                ...
                RichText(
                  ...
                  text: TextSpan(
                    ...
                    children: [
                      ...
                      TextSpan(
                        text: AppLocalization.of(context).translate('You can now buy your property within'),
                        style: const TextStyle(
                          fontSize: 16,
                          fontWeight: FontWeight.w700,
                          color: Colors.black,
