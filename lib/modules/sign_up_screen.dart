        ...
        listener: (context,state){
          if(state is SignUpSuccessfulState){
            ...
            Alert(
                ...
                title:AppLocalization.of(context).translate('This number is already in use')!,
            ...
            Alert(
                ...
                title: '${AppLocalization.of(context).translate('Something wrong')}',
                              ...
                              child: SingleChildScrollView(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    DefaultText(
                                      myText: AppLocalization.of(context).translate('Sign Up'),
                                      style: Styles.getBoldMainTextStyle(color: Colors.black,fontSize: FontSize.s22),
                                    ),
                                    const SizedBox(height: 22,),
                                    DefaultFormField(
                                      inputFormatter: [
                                        FilteringTextInputFormatter.deny(RegExp("[ا-ى]")),
                                      ],
                                      astric: false,
                                      ...
                                      validator: (value){
                                        if(value!.isEmpty){
                                          return AppLocalization.of(context).translate('Please enter your email');
                                        }
                                        else if(!EmailValidator.validate(value)){
                                          return AppLocalization.of(context).translate('Please enter the email correct format');
                                        }
                                        return null;
                                      },
                                    ...
                                    DefaultFormField(
                                      ...
                                      validator: (value){
                                        if(value!.isEmpty){
                                          return AppLocalization.of(context).translate('Please enter your mobile number');
                                        }
                                    ...
                                    DefaultButton(
                                      onPressed: (){
                                        if(formKey1.currentState!.validate()){
                                           ...
                                           cubit.checkPhone(phoneNumber: cubit.phoneController.text);
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Text(
                                            ...
                                            AppLocalization.of(context).translate('Do you have an account')!,
                                            textAlign: TextAlign.center,
                                            style: Styles.getMidMainTextStyle(color: Colors.black,fontSize: FontSize.s14),
                                          ...
                                          TextButton(
                                            ...
                                            child: Text(
                                              ...
                                              style: Styles.getBoldMainTextStyle(color: ColorManager.primary,fontSize: FontSize.s14),
                                            ),
                                            onPressed: (){
                                            navigateTo(context: context, nextScreen: LoginScreen());
                                            },
                                          ),
                                        ],
                                      ),
