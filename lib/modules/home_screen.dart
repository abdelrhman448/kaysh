      ...
      builder: (context,state){
        ...
        return  Scaffold(
            ...
            body:  Conditional.single(
              ...
              widgetBuilder: (context)=>cubit.homeModel!=null?Padding(
                        ...
                        child: HeadItem(
                          ...
                          onTab: (){
                            if(CasheHelper.getData(key: isNotRegister)==true){
                              ...
                              navigateTo(context: context, nextScreen:OnGoingDealsScreen());
                            }
                          },
                        ),
                      ),
                                ...
                                itemBuilder: (context,index)=>InkWell(
                                  onTap: () {
                                    ...
                                    if(CasheHelper.getData(key: isNotRegister)==true){
                                      ...
                                      if(cubit.homeModel!.data!.currentAuctions[index].endTime!*1000-DateTime.now().millisecondsSinceEpoch>0){
                                        navigateTo(context: context, nextScreen: DealsDetailsScreen(auctionId: cubit.homeModel!.data!.currentAuctions[index].id!));
                                      }
                                      else{
                                  ...
                                  child: UnitItem(
                                    onFollowTab: (){
                                      if(!CasheHelper.getData(key: isVerified)){
                                        ...
                                        cubit.followedList[cubit.homeModel!.data!.currentAuctions[index].id!]=!cubit.followedList[cubit.homeModel!.data!.currentAuctions[index].id!]!;
                                        cubit.addFollow(cubit.homeModel!.data!.nextAuctions[index].id!);
                                      }
                                    },
                                    screenType: 1,
                                    ...
                                    auctionId: cubit.homeModel!.data!.currentAuctions[index].id,
                                    width: width * .75,
                                    image: cubit.homeModel!.data!.currentAuctions[index].realestateImage,
                                    follow: true,
                                     followState: cubit.homeModel!.data!.currentAuctions[index].followed!,
                                    title: cubit.homeModel!.data!.currentAuctions[index].realestateTitle,
                                    auctionsNumber:cubit.homeModel!.data!.currentAuctions[index].dealId.toString(),
                                    isFinished: true,
                                    live: true,
                                    fromTime: false,

                                    time: '12:5',
                                    distance: cubit.homeModel!.data!.currentAuctions[index].realestateSpace.toString(),
                                    location: '${cubit.homeModel!.data!.currentAuctions[index].realestateCity}-${cubit.homeModel!.data!.currentAuctions[index].realestateReigon}',
                                    price: '2532422',
                                    status: AppLocalization.of(context).translate('Running now'),
                                    unitType: cubit.homeModel!.data!.currentAuctions[index].realestateType,

                                  ),
                                ),
                                separatorBuilder:(context,index)=> const SizedBox(width: 16,),
                                itemCount: cubit.homeModel!.data!.currentAuctions.length,
                      ...
                      if( cubit.homeModel!.data!.currentAuctions.isEmpty)
                        Padding(
                          ...
                          child: Container(
                            ...
                            child:Center(child: Text(AppLocalization.of(context).translate('No auctions')!)),
                          ),
                        ),
                        ...
                        child: HeadItem(
                          ...
                          onTab: (){
                            if(CasheHelper.getData(key: isNotRegister)==true){
                              ...
                              navigateTo(context: context, nextScreen:UpComingDealsScreen());
                            }
                          },
                        ),
                      ),
                                ...
                                itemBuilder: (context,index)=>InkWell(
                                  onTap: (){
                                    if(CasheHelper.getData(key: isNotRegister)==true){
                                      ...
                                      navigateTo(context: context, nextScreen: DealsDetailsScreen(auctionId: cubit.homeModel!.data!.nextAuctions[index].id!));
                                    }
                                  ...
                                  child:UnitItem(
                                    onFollowTab: (){
                                      if(!CasheHelper.getData(key: isVerified)){
                                        ...
                                        cubit.followedList[cubit.homeModel!.data!.nextAuctions[index].id!]=!cubit.followedList[cubit.homeModel!.data!.nextAuctions[index].id!]!;
                                        cubit.addFollow(cubit.homeModel!.data!.nextAuctions[index].id!);
                                      }
                                    },
                                    screenType: 1,
                                    inComing: true,
                                    auctionId: cubit.homeModel!.data!.nextAuctions[index].id,
                                    width: width * .75,
                                    image: cubit.homeModel!.data!.nextAuctions[index].realestateImage,
                                    borderColor: ColorManager.primary,
                                    statusColor: ColorManager.primary,
                                    follow: true,
                                    followState: cubit.homeModel!.data!.nextAuctions[index].followed,
                                    title: cubit.homeModel!.data!.nextAuctions[index].realestateTitle,
                                    auctionsNumber:cubit.homeModel!.data!.nextAuctions[index].dealId.toString(),
                                    isFinished: true,

                                    time: '12:5',
                                    distance: cubit.homeModel!.data!.nextAuctions[index].realestateSpace.toString(),
                                    location: '${cubit.homeModel!.data!.nextAuctions[index].realestateCity} - ${cubit.homeModel!.data!.nextAuctions[index].realestateReigon}',
                                    price: '2532422',
                                    status: nextAuctionLeftTime(context: context,adTime: cubit.homeModel!.data!.nextAuctions[index].startTime!),
                                    unitType: cubit.homeModel!.data!.nextAuctions[index].realestateType,

                                  ),
                                ),
                                separatorBuilder:(context,index)=> const SizedBox(width: 16,),
                                itemCount: cubit.homeModel!.data!.nextAuctions.length,
                        ...
                        child: HeadItem(
                          ...
                          onTab: (){
                            if(CasheHelper.getData(key: isNotRegister)==true){
                              ...
                              navigateTo(context: context, nextScreen: FinishedDealsScreen());
                            }
                          },
                        ),
                      ),
                              ...
                              itemBuilder: (context,index)=>InkWell(
                                onTap: (){
                                  if(CasheHelper.getData(key: isNotRegister)==true){
                                    ...
                                    navigateTo(context: context, nextScreen: DealsDetailsScreen(auctionId: cubit.homeModel!.data!.doneAuctions[index].id!));
                                  }
                                ...
                                child: UnitItem(
                                  screenType: 1,
                                  auctionId: cubit.homeModel!.data!.doneAuctions[index].id,
                                  image: cubit.homeModel!.data!.doneAuctions[index].realestateImage,
                                  width: width * .75,
                                  borderColor: Colors.grey.shade600,
                                  statusColor: Colors.grey.shade600,
                                  follow: false,

                                  title: cubit.homeModel!.data!.doneAuctions[index].realestateTitle,
                                  auctionsNumber:cubit.homeModel!.data!.doneAuctions[index].dealId.toString(),
                                  isFinished: true,
                                  time: '12:5',
                                  fromTime: false,
                                  distance: cubit.homeModel!.data!.doneAuctions[index].realestateSpace.toString(),
                                  location: '${cubit.homeModel!.data!.doneAuctions[index].realestateCity}-${cubit.homeModel!.data!.doneAuctions[index].realestateReigon}',
                                  price: cubit.homeModel!.data!.doneAuctions[index].maximum.toString(),
                                  status: AppLocalization.of(context).translate('Finished'),
                                  unitType: cubit.homeModel!.data!.doneAuctions[index].realestateType,

                                ),
                              ),
                              separatorBuilder:(context,index)=> const SizedBox(width: 16,),
                              itemCount: cubit.homeModel!.data!.doneAuctions.length,
