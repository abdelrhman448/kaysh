...
LayoutScreen({
  ...
  Widget build(BuildContext context) {
    ...
    FirebaseMessaging.onMessage.listen((RemoteMessage message) {
     ...
     switch( message.data['state']){
       case '2':
         navigateTo(context: context, nextScreen: ResultOfTransactionScreen(state: 2,));
         break;
       case '-2':
       navigateTo(context: context, nextScreen: ResultOfTransactionScreen(state: -2,));
       break;
       case '1':
         ...
         HomeCubit.get(context).getHomeData(cityId: 0,regionId: 0,districtId: 0,realStateTypeId: 0).then((value) {
    ...
    FirebaseMessaging.onMessageOpenedApp.listen((RemoteMessage message) {
      ...
      switch( message.data['state']){
        ...
        case '1':
          ...
          HomeCubit.get(context).getHomeData(cityId: 0,regionId: 0,districtId: 0,realStateTypeId: 0).then((value) {
            navigateTo(context: context, nextScreen: AccountVerificationRequest());
          });
          break;
        case'-1':
          ...
          break;
        case '3':
          navigateAndFinish(context: context, nextScreen: LayoutScreen(pageNumber: 2,));
      }
      ...
      builder: (context,state){
        return  Scaffold(
          ...
          appBar: AppBar(
            ...
            systemOverlayStyle: const SystemUiOverlayStyle(statusBarColor: ColorManager.primary),
            title: Text(titles(context)[cubit.currentIndex],
              style: appBarTitle,
            ),
            centerTitle: true,
            elevation: 0.0,
                     ...
                     children: [
                       MaterialButton(
                         ...
                         child: cubit.currentIndex==0?
                             ActiveButton(icon: 'icons/home.png', label: 'Main'):
                         const Image(image: AssetImage('icons/home.png'),color: ColorManager.primary,height: 20,width: 20,),
                         onPressed:(){
                       ...
                       MaterialButton(
                         minWidth: width*.2,
                           ...
                           ActiveButton(icon: 'icons/notification.png', label: 'Notifications'):
                            Stack(
                              children:  [
                                const Image(image: AssetImage('icons/notification.png'),color: ColorManager.primary,height: 20,width: 20,),
                       ...
                       MaterialButton(
                         minWidth: width*.2,
                           ...
                           ActiveButton(icon: 'icons/settings.png', label: 'Settings'):
                           const Image(image: AssetImage('icons/settings.png'),color: ColorManager.primary,height: 20,width: 20,),
                           onPressed:(){
                       ...
                       MaterialButton(
                           ...
                           ActiveButton(icon: 'icons/about_us.png', label: 'About us'):
                          const Image(image: AssetImage('icons/about_us.png'),color: ColorManager.primary,height: 20,width: 20,),
                           onPressed:(){
 ...
 //layout titles
  List<String> titles(context){
    ...
    List<String> titles=[localization.translate('Main')!,localization.translate('Notifications')!,
      localization.translate('Settings')!,localization.translate('About us')!
    ];
    return titles;
  }
  //layout screens
  List<Widget> screens (){
    List<Widget> screens=[HomeScreen(),NotificationScreen(),SettingsScreen(),AboutUsScreen()];
    return screens;
  }
  //layout actions
  List<Widget> actions(context){
    List<Widget> actions=[
      Padding(
        ...
        child: IconButton(
          icon: const Image(image: AssetImage('icons/sort.png'),width: 20,height: 20,),
      ...
      Padding(
        padding: const EdgeInsetsDirectional.only(end: 16),
        child: IconButton(
          icon: const Image(image: AssetImage('icons/notification_settings.png'),width: 20,height: 20,),
